...
export function calcPOPScoreCore({
  ...
  // Step 5
  let ratio = adjusted_expected_minutes / adjusted_actual_minutes;
  // 'constant' pace delay: floor ratio at 1.0 — player not penalized for course mismanagement
  if (paceDelay === 'constant') {
