...
export default function SignUpScreen({ navigation }) {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.congratsContent}>
          ...
          <TouchableOpacity
            style={[styles.btnPrimary, letsPlayLoading && styles.btnDisabled]}
            onPress={() => {
              if (usernameConflict) {
  ...
  const renderStep0 = () => (
    <View style={styles.stepContent}>
      <Text style={styles.stepTitle}>How will you use PlayThru?</Text>
      <TouchableOpacity
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.acctCardSub}>Track your pace, log rounds, earn a POPScore</Text>
        </View>
        {accountType === 'golfer' && (
  ...
  const renderCaddyCoursesStep = () => (
    <View style={styles.stepContent}>
      ...
      <Text style={styles.caddyCourseHint}>
        This will be your home base on PlayThru
      </Text>
    </View>
  );
